# Generated by Django 2.0.7 on 2018-07-09 23:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rule_type', models.CharField(choices=[('surt', 'SURT'), ('surt-neg', 'SURT negation'), ('regex', 'regular expression'), ('daterange', 'date range'), ('warcname', 'WARC name (or regex)'), ('collection', 'collection'), ('partner', 'partner')], max_length=10)),
